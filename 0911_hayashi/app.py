'''
#####
で検索をしてもらうと、追加箇所・変更箇所が分かります。

また、static/button.css 追加
    join.html   編集
をそれぞれ行いました。

データベース名とpy名を変えてしましました。
すみません。
...
def register():
    ...
    if request.method == "GET":
        ...
        try:
            # 「""」も必要！
            new_user = db.execute("INSERT INTO users (username, hash, is_anonymous) VALUES (?, ?, 0)", username, hash)
        except:
